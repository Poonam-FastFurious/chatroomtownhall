  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate("/Chat"); // Redirect to chat routes after successful login
      } else {
            ...
            <div className="mx-5 lg:mx-20 lg:col-start-5 lg:col-span-4">
              <div className="text-center">
                <Link to="/" className="block mb-10">
                  <img
                    src="http://localhost:5173/src/assets/logo-no-background.png"
                    alt=""
                ...
                <h4 className="mb-2 text-gray-800 text-21 ">Sign in</h4>
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-5">
                        ...
                        <div className="flex items-center mt-2 mb-3 rounded-3 bg-slate-50/50 dark:bg-transparent">
                          <span
                            className="flex items-center px-4 py-2 text-gray-500 border border-r-0 border-gray-100 rounded rounded-r-none "
                            id="basic-addon3"
                          >
                      ...
                      <div className="flex items-center mb-6">
                        ...
                        />
                        <label
                          className="font-medium text-gray-700 ltr:ml-2 rtl:mr-2 "
                      ...
                      <div className="grid">
                        <button
                          className="py-2 text-white border-transparent btn bg-[#B18D57] hover:bg-violet-600 text-16"
                          type="submit"
                          disabled={loading}
                        >
